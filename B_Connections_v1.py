...
def get_items():
    ...
    # Retrieve all items from csv file and put them in a list
...
def get_round_results():
    ...
    """
    Choose four answers and words from list, ensuring that all results I get in the round are all different.
    This way there is no duplicate results.
    Return: list of answers, connections and clues from the list made in my get.
    """
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        # Format items in play labels list
        play_labels_ref = []
    ...
    def new_round(self):
        ...
        # Enable all of the answer buttons for a playable game
