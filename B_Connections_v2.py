...
class StartGame:
    ...
    def __init__(self):
        ...
        self.num_rounds_entry = Entry(self.entry_area_frame, font=("Arial", "20", "bold"),
                                        width=10)
        self.num_rounds_entry.grid(row=1, column=0, padx=10, pady=10)

        # Create Clue buttons 
        self.clues_on_button = Button(self.entry_area_frame, font=heading_font,
                                        fg="#FFFFFF", bg="#00D828", text="Clues enabled", width=15, command=button_clicked)
        
        self.clues_on_button.grid(row=0, column=0, padx=10, pady=10)
        
        self.clues_off_button = Button(self.entry_area_frame, font=heading_font,
                                        fg="#FFFFFF", bg="#D80000", text="Clues disabled", width=15, command=button_clicked)
        
        self.clues_off_button.grid(row=0, column=1, padx=10, pady=10)

        # Create play button
        self.play_button = Button(self.entry_area_frame, font=heading_font,
                                    fg="#FFFFFF", bg="#0057D8", text="Play", width=10,
                                    command=self.check_rounds)
        self.play_button.grid(row=1, column=1, padx=20, pady=20)
